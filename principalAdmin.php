...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar " style="background-color: #014671;">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="gMedicos.php" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="gPacientes.php" data-toggle="collapse" data-target="#collapseUtilities"
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-4 text-gray-800">Bienvenido al portal administrativo del SIS</h1>
                <div class ="row">

                    <!-- Earnings (Medicos) Card Example -->
                                    ...
                                    <div class="col mr-2">                  
                                        <div class="card shadow mb-4">
                                            <div class="card-header py-3">
                                                <h6 class="m-0 font-weight-bold text-primary">Gestion de Medicos</h6>
                                            </div>
                                            <div class="card-body">
